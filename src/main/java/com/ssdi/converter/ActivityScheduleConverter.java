...
public class ActivityScheduleConverter {
	...
	public static ActivityScheduleDto entityToDto(ActivitySchedule actSch) {
		return new ActivityScheduleDto(actSch.getId(),actSch.getVenue().getVenueName(),actSch.getActivity().getActivity_name(), actSch.getDay().getDay_of_week(), actSch.getStart_at(),actSch.getEnd_at());
	}
